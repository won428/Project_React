...
function App() {
    ...
    const [form, setForm] = useState({
        ...
        content: '',
        appliedDate: today,
        targetDate: today // 🔥 캘린더 선택용 필드 추가
    });
        ...
        axios.get(`${API_BASE_URL}/api/student/record/${recordId}`)
            .then(res => {
                ...
                setForm({
                    ...
                    targetDate: data.targetDate ? data.targetDate.slice(0, 10) : today
                });
    ...
    const submitForm = () => {
        const body = {
            ...
            targetDate: showCalendar ? form.targetDate : null,
            status: 'PENDING'
        };
