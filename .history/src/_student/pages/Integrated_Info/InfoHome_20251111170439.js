    ...
    <Container>
      ...
      <table style={{ borderCollapse: 'collapse', width: '100%', marginTop: '1rem', tableLayout: 'fixed' }}>
        <tbody>
          ...
          <tr><th style={{ border: '1px solid #ddd', padding: '8px' }}>교양 학점</th><td style={{ border: '1px solid #ddd' }}>{statusRecords.generalCredit}</td></tr>
          <tr><th style={{ border: '1px solid #ddd', padding: '8px' }}>총 학점</th><td style={{ border: '1px solid #ddd' }}>{statusRecords.totalCredit}</td></tr>
          <tr><th style={{ border: '1px solid #ddd', padding: '8px' }}>이번 학기 학점</th><td style={{ border: '1px solid #ddd' }}>{statusRecords.currentCredit}</td></tr>
        </tbody>
      </table>
    </Container>
  );
