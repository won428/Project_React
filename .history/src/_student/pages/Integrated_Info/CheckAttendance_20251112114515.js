...
function App() {
    ...
    const handleAppeal = (form) => {
        ...
        navigate(`/AttendanceAppeal/${form.lectureId}`, { state: { lecture: form, sessions: selectedSessions, attendanceType: selectedRow.attendStudent === "지각" ? "LATE" : "ABSENT" } });
    };
