...
function App() {
    ...
    return (
        <Container fluid className="py-4" style={{ maxWidth: "100%" }}>
            ...
            <Row className="mb-3 align-items-center" style={{ columnGap: 12 }}>
                <Col xs="auto">
                    <Form.Label className="me-2">신청 목적</Form.Label>
                    <Form.Select
                        name="studentStatus"
                        value={form.studentStatus}
                        onChange={onChange}
                        required
                        style={{ width: 220, fontSize: '0.875rem', padding: '0.25rem 0.5rem' }}
                    >
                ...
                <Col xs="auto">
                    <Form.Label className="me-2">신청일</Form.Label>
                    <Form.Control
                        type="date"
                        name="appliedDate"
                        ...
                        readOnly
                        disabled
                        style={{ width: 160, fontSize: '0.875rem', padding: '0.25rem 0.5rem' }}
                    />
                </Col>
            </Row>
