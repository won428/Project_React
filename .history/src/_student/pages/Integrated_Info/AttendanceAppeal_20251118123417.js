...
function AttendanceAppeal({ readOnly = false, appealData = null }) {
    const { user } = useAuth();
    ...
    const [appealForm, setAppealForm] = useState(
        appealData || {
            ...
            attendanceType: attendanceFromModal || 'ABSENT',
            attendanceDetail: '',
        ...
        <Container style={{ maxWidth: 720, marginTop: 24, marginBottom: 24 }}>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                {!readOnly && (
                    <>
                        <Form.Group className="mb-3">
                            <Form.Label>증빙 파일 첨부 (선택, 여러 개 가능)</Form.Label>
