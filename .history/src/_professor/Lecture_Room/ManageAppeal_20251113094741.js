            ...
            {modalMode === "gradeView" && selectedAppeal && (
                <Modal show onHide={() => setModalMode("")} centered>
                    ...
                    <Modal.Body>
                        ...
                        {/* 성적 정보 (disabled 처리) */}
                        {["ascore", "asScore", "tscore", "tsScore", "ftScore"].map((k) => (
                            <Form.Group key={k} className="mb-2">
                                <Form.Label>
                                    {k === "ascore" || k === "asScore" ? "과제 점수" :
                                        k === "tscore" || k === "tsScore" ? "중간 점수" :
                                            k === "ftScore" ? "기말 점수" : k}
                                </Form.Label>
                                <Form.Control
                                    type="number"
                                    value={selectedAppeal[k] ?? ""}
                                    disabled
                                />
                            </Form.Group>
                        ))}
                        ...
                        <Form.Group className="mb-2">
                            ...
                            <Form.Control
                                type="number"
                                value={selectedAppeal.totalScore ?? ""}
                                disabled
                            />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-2">
                            ...
                            <Form.Control
                                type="text"
                                value={selectedAppeal.lectureGrade ?? ""}
                                disabled
                            />
                        </Form.Group>
