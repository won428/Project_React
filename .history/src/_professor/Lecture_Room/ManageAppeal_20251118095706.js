...
×
ERROR
Cannot access 'lectureId' before initialization
ReferenceError: Cannot access 'lectureId' before initialization
    at ManageAppeal (http://localhost:3000/main.cfdd1addfe82b172615f.hot-update.js:45:32)
    at Object.react_stack_bottom_frame (http://localhost:3000/static/js/bundle.js:97585:18)
    at renderWithHooks (http://localhost:3000/static/js/bundle.js:88458:20)
    at updateFunctionComponent (http://localhost:3000/static/js/bundle.js:89847:17)
    at beginWork (http://localhost:3000/static/js/bundle.js:90416:16)
    at runWithFiberInDEV (http://localhost:3000/static/js/bundle.js:84934:68)
    at performUnitOfWork (http://localhost:3000/static/js/bundle.js:92843:93)
    at workLoopSync (http://localhost:3000/static/js/bundle.js:92738:38)
    at renderRootSync (http://localhost:3000/static/js/bundle.js:92723:7)
    at performWorkOnRoot (http://localhost:3000/static/js/bundle.js:92396:33)
    ...
    const handleApproveSubmit = async () => {
        ...
        try {
            if (selectedAppeal.appealType === "ATTENDANCE") {
                await axios.put(`${API_BASE_URL}/api/appeals/${selectedAppeal.appealId}/updateStatus`, null, {
                    params: {
