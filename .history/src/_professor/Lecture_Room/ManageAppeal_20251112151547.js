                        ...
                        <>
                            {modalMode === "view" && (
                                <>
                                    ...
                                    {/* 🔹 학생이 신청한 점수 항목 (성적 이의제기) */}
                                    {selectedAppeal.appealType !== "ATTENDANCE" && (
                                        <Form.Group className="mb-2">
                                            <Form.Label>이의제기 항목</Form.Label>
                                            <Form.Control
                                                type="text"
                                                value={
                                                    selectedAppeal.appealType === "ASSIGNMENT" ? "과제" :
                                                        selectedAppeal.appealType === "MIDTERMEXAM" ? "중간고사" :
                                                            selectedAppeal.appealType === "FINALEXAM" ? "기말고사" :
                            ...
                            {modalMode === "view" && selectedAppeal.appealType === "ATTENDANCE" && (
                                <>
                                    ...
                                    <Form.Group className="mb-2">
                                        ...
                                        <Form.Control
                                            type="text"
                                            value={ATTENDANCE_TYPES.find(o => o.value === selectedAppeal.attendanceType)?.label || selectedAppeal.attendanceType}
                                            disabled
                                        />
                                    </Form.Group>

                                    <Form.Group className="mb-2">
                                        <Form.Label>출결 세부 사유</Form.Label>
                                        <Form.Control
                                            type="text"
                                            value={ATTENDANCE_DETAILS.find(o => o.value === selectedAppeal.attendanceDetail)?.label || selectedAppeal.attendanceDetail || ""}
                                            disabled
                                        />
                                    </Form.Group>

                                    {selectedAppeal.attendanceDates && selectedAppeal.attendanceDates.length > 0 && (
                                        <Form.Group className="mb-2">
                                            <Form.Label>관련 날짜</Form.Label>
                                            <Form.Control
                                                type="text"
                                                value={selectedAppeal.attendanceDates.map(d => new Date(d).toLocaleDateString()).join(", ")}
                                                disabled
                                            />
                                        </Form.Group>
                                    )}
                            ...
                            {modalMode === "view" && selectedAppeal.appealType === "ATTENDANCE" && (
                                <>
                                    <Form.Group className="mb-2">
                                        ...
                                        <Form.Control
                                            type="text"
                                            value={ATTENDANCE_TYPES.find(o => o.value === selectedAppeal.attendanceType)?.label || ""}
                                            disabled
                                        />
                                    </Form.Group>
                                    <Form.Group className="mb-2">
                                        ...
                                        <Form.Control
                                            type="text"
                                            value={ATTENDANCE_DETAILS.find(o => o.value === selectedAppeal.attendanceDetail)?.label || ""}
                                            disabled
                                        />
                                    </Form.Group>
                                    <Form.Group className="mb-2">
                                        <Form.Label>출결 기간</Form.Label>
                                        <Form.Control
                                            type="text"
                                            value={selectedAppeal.startDate && selectedAppeal.endDate
                                                ? `${selectedAppeal.startDate} ~ ${selectedAppeal.endDate}`
                                                : ""}
                                            disabled
                                        />
                                    </Form.Group>
