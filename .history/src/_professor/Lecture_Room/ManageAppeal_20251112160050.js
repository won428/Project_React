    ...
    return (
        <Container style={{ marginTop: 24 }}>
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)} centered>
                ...
                <Modal.Body>
                    {selectedAppeal && selectedAppeal.appealType === "ATTENDANCE" && (
                        <>
                            <Form.Group className="mb-2">
                                <Form.Label>학생 이름</Form.Label>
                                <Form.Control type="text" value={selectedAppeal.studentName} readOnly />
                            </Form.Group>

                            <Form.Group className="mb-2">
                                <Form.Label>강의일</Form.Label>
                                <Form.Control type="text" value={selectedAppeal.lectureDate} readOnly />
                            </Form.Group>

                            <Form.Group className="mb-2">
                                <Form.Label>현재 출결 상태</Form.Label>
                                <Form.Control type="text" value={getAttendanceTypeLabel(selectedAppeal.attendanceType)} readOnly />
                            </Form.Group>
                    ...
                    {/* 성적 이의제기 모달는 기존 구조 유지 */}
                    {selectedAppeal && selectedAppeal.appealType !== "ATTENDANCE" && modalMode === "approve" && (
                        <>
                            <Form.Group className="mb-2">
                                <Form.Label>학생 이름</Form.Label>
