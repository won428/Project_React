...
function App() {
    ...
    const openModal = (appeal) => {
        ...
        setUpdatedScores({
            aScore: appeal.ascore || 0,   // 출석점수
            asScore: appeal.asScore || 0, // 과제점수
            tScore: appeal.tscore || 0,   // 중간고사
            ftScore: appeal.ftScore || 0, // 기말고사
                        ...
                        <Form>
                            ...
                            <Form.Group className="mb-2">
                                ...
                                <Form.Control
                                    type="number"
                                    name="aScore"
                                    value={updatedScores.aScore === 0 ? "" : updatedScores.aScore}
                                    onChange={handleScoreChange}
                                    onWheel={(e) => e.target.blur()} // 휠 스크롤 방지
                            ...
                            <Form.Group className="mb-2">
                                ...
                                <Form.Control
                                    type="number"
                                    name="asScore"
                                    value={updatedScores.asScore === 0 ? "" : updatedScores.asScore}
                                    onChange={handleScoreChange}
                            ...
                            <Form.Group className="mb-2">
                                ...
                                <Form.Control
                                    type="number"
                                    name="tScore"
                                    value={updatedScores.tScore === 0 ? "" : updatedScores.tScore}
                                    onChange={handleScoreChange}
                                    onWheel={(e) => e.target.blur()}
                                    style={{ MozAppearance: "textfield" }}
                                    inputMode="numeric"
                            ...
                            <Form.Group className="mb-2">
                                ...
                                <Form.Control
                                    type="number"
                                    name="ftScore"
                                    value={updatedScores.ftScore === 0 ? "" : updatedScores.ftScore}
                                    onChange={handleScoreChange}
                                    onWheel={(e) => e.target.blur()}
                                    style={{ MozAppearance: "textfield" }}
                                    inputMode="numeric"
                            ...
                            <Form.Group className="mb-2">
                                ...
                                <Form.Control
                                    type="number"
                                    name="totalScore"
                                    value={updatedScores.totalScore === 0 ? "" : updatedScores.totalScore}
                                    onChange={handleScoreChange}
                                    onWheel={(e) => e.target.blur()}
                                    style={{ MozAppearance: "textfield" }}
                                    inputMode="numeric"
                            ...
                            <Form.Group className="mb-2">
                                ...
                                <Form.Control
                                    type="number"
                                    name="lectureGrade"
                                    value={updatedScores.lectureGrade === 0 ? "" : updatedScores.lectureGrade}
                                    onChange={handleScoreChange}
                                    onWheel={(e) => e.target.blur()}
                                    style={{ MozAppearance: "textfield" }}
                                    inputMode="numeric"
