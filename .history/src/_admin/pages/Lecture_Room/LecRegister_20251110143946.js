                  ...
                  <Col md={3}>
                    <div className="input-group input-group-sm">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => {
                          const value = e.target.value;
                          setPercent((previous) => ({ ...previous, attendance:  Number(value) }));
                        }}
                      />
                  ...
                  <Col md={3}>
                    <div className="input-group input-group-sm">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => {
                          const value = e.target.value;
                          setPercent((previous) => ({ ...previous, assignment:  Number(value) }));
                        }}
                      />
                      <span className="input-group-text">%</span>
                    </div>
                  ...
                  <Col md={3}>
                    <div className="input-group input-group-sm">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => {
                          const value = e.target.value;
                          setPercent((previous) => ({ ...previous, midtermExam:  Number(value) }));
                        }}
                      />
                      <span className="input-group-text">%</span>
                    </div>
                    ...
                    <div className="input-group input-group-sm">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => {
                          const value = e.target.value;
                          console.log(percent);
                          setPercent((previous) => ({ ...previous, finalExam: Number(value) }));
                        }}
                      />
                      <span className="input-group-text">%</span>
                    </div>
