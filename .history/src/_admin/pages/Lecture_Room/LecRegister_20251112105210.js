                  ...
                  <div className="input-group input-group-sm">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        ...
                        setPercent((previous) => ({ ...previous, attendance: value === "" ? 0 : Number(value) }));
                      }}
                    />
                ...
                <Col md={3}>
                  <div className="input-group input-group-sm">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        const value = Number(e.target.value);
                        setPercent((previous) => ({ ...previous, assignment: value === "" ? 0 : Number(value) }));
                      }}
                    />
                    <span className="input-group-text">%</span>
                  </div>
                ...
                <Col md={3}>
                  <div className="input-group input-group-sm">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        const value = Number(e.target.value);
                        setPercent((previous) => ({ ...previous, midtermExam: value === "" ? 0 : Number(value) }));
                      }}
                    />
                    <span className="input-group-text">%</span>
                  </div>
                ...
                <Col md={3}>
                  <div className="input-group input-group-sm">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        const value = Number(e.target.value);
                        setPercent((previous) => ({ ...previous, finalExam: value === "" ? 0 : Number(value) }));
                      }}
                    />
                    <span className="input-group-text">%</span>
                  </div>
