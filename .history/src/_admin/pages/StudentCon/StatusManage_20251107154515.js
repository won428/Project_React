...
function StatusManage() {
    // const { userId } = useParams();import React, { useEffect, useState } from 'react';
import { Container, Form, Button, Row, Col } from 'react-bootstrap';
import axios from 'axios';
import { API_BASE_URL } from '../../../public/config/config';
                ...
                <>
                    ...
                    {['GRADUATED', 'EXPELLED'].includes(studentInfo.academicStatus) && (
                        <>
                            ...
                            <Form.Control
                                type="date"
                                value={studentInfo.academicStatus === 'GRADUATED' ? studentInfo.graduationDate : studentInfo.retentionDate}
                                onChange={(e) => handleChange(studentInfo.academicStatus === 'GRADUATED' ? 'graduationDate' : 'retentionDate', e.target.value)}
                            />
                        </>
                    )}
