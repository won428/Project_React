                ...
                {record ? (
                    <Form>
                        ...
                        {showCalendar && record && (
                            <Row className="mb-3">
                                <Col md={6}>
                                    <Form.Label>처리 시작일</Form.Label>
                                    <Form.Control type="date" value={record.targetStartDate || ''} disabled />
                                </Col>
                                <Col md={6}>
                                    <Form.Label>처리 종료일</Form.Label>
                                    <Form.Control type="date" value={record.targetEndDate || ''} disabled />
                                </Col>
                            </Row>
                        )}
